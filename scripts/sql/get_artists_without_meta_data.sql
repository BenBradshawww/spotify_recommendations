WITH recent_tracks AS (
    SELECT DISTINCT
        spotify_recent_tracks_artist_id AS spotify_artist_id 
    FROM spotify_recent_tracks
),

old_tracks AS (
    SELECT DISTINCT
        spotify_old_tracks_artist_id AS spotify_artist_id
    FROM spotify_old_tracks
),

playlists AS (
    SELECT DISTINCT 
        spotify_playlists_track_artists AS artists
...
SELECT DISTINCT spotify_recent_tracks_artist_id 
